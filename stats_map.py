    ...
    page.add(
        ...
        map.Map(
            ...
            configuration=map.MapConfiguration(
                initial_center=map.MapLatitudeLongitude(48, 12),
                initial_zoom=4.2,
            ...
            layers=[
                ...
                map.MarkerLayer(
                    ...
                    markers=[
                        map.Marker(
                            content=ft.IconButton(content=ft.Icon(ft.icons.LOCATION_ON,color="red", ),
                                                    alignment=ft.alignment.center,
                                                 on_click=lambda e: print("Clicked Marker")),
